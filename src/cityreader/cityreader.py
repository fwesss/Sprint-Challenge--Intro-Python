...
class City:
    ...
    def __str__(self):
        return f"a city named {self.name} located at {self.lat}, {self.lon}"
...
def cityreader(cities_list=None) -> List[City]:
    ...
    with open("cities.csv") as csv_file:
        ...
        for row in csv_reader:
            cities_list.append(City(row["city"], float(row["lat"]), float(row["lng"])))
